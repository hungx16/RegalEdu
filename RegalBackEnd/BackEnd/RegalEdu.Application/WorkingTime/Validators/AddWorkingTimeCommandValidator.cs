...
{
    public class AddWorkingTimeCommandValidator : AbstractValidator<AddWorkingTimeCommand>
    {
        public AddWorkingTimeCommandValidator(ILocalizationService localizer, IRegalEducationDbContext db)
        {
