...
namespace RegalEdu.Application.Course.Queries
{
    ...
    public class GetCourseByIdQueryHandler : IRequestHandler<GetCourseByIdQuery, Result<CourseModel>>
    {
        private readonly IRegalEducationDbContext _context;
        private readonly IMapper _mapper;
        private readonly ILocalizationService _localizer;

        public GetCourseByIdQueryHandler(IRegalEducationDbContext context, IMapper mapper, ILocalizationService localizer)
        {
        ...
        public async Task<Result<CourseModel>> Handle(GetCourseByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var course = await _context.Courses
                .Include(c => c.LearningRoadMap).Include(c => c.DetailRegisterStudies).Include(c => c.Tuitions)
