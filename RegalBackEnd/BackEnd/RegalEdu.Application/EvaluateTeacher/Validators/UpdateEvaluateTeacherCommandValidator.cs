...
{
    public class UpdateEvaluateTeacherCommandValidator : AbstractValidator<UpdateEvaluateTeacherCommand>
    {
        public UpdateEvaluateTeacherCommandValidator(ILocalizationService localizer)
        {
