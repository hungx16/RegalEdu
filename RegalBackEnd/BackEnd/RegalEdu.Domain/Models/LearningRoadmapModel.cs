...
{
    public class LearningRoadMapModel : BaseEntityModel
    {
        [Required]
        [MaxLength (10)]
        ...
        //Thuộc tính AgeGroup sử dụng AgeGrId làm foreign key để liên kết với bảng Category
        [ForeignKey (nameof (AgeGrId))]
        public virtual CategoryModel? AgeGroup { get; set; } = null!;
