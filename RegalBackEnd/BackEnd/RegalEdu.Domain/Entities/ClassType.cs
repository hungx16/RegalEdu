...
public class ClassType : BaseEntity // Nếu có BaseEntity, sẽ có Id, CreatedAt, CreatedBy...
{
    ...
    public ICollection<Class> Classes { get; set; } = new List<Class> ( ); // Danh sách các lớp học thuộc loại này


    public int ClassCount { get; set; } // Số lớp (có thể là số lớp áp dụng cho loại này)
    //public virtual ICollection<DetailRegisterStudy>? DetailRegisterStudy { get; set; }
