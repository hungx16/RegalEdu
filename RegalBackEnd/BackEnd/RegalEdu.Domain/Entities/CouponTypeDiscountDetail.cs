...
{
    // Chi tiết chiết khấu
    public class CouponTypeDiscountDetail : BaseEntity // BaseEntity: Id, CreatedAt, CreatedBy,...
    {
        ...
        public virtual CouponTypeDiscount? CouponTypeDiscount { get; set; } //chiết khấu áp dụng
    }
}
