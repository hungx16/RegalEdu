<template>
    <BaseDialogForm ref="baseDialogRef" :visible="visible" :title="`${modeTitle} - ${formData.fullName}`"
        :form-data="formData" :rules="rules" :mode="props.mode" :loading="loading" @submit="onSubmit" @delete="onDelete"
        :width="computedDialogWidth" @update:visible="emit('update:visible', $event)" @close="closeModal">
        <template #form>
