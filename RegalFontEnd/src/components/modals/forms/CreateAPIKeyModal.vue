          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true"
              ...
              <div class="mb-5 fv-row">
                ...
                <!--begin::Input-->
                <Field type="text" class="form-control form-control-solid" placeholder="Your API Name" name="apiName"
              ...
              <div class="d-flex flex-column mb-5 fv-row">
                ...
                <!--begin::Input-->
                <Field type="text" class="form-control form-control-solid" rows="3" name="shortDescription"
                  placeholder="Describe your API" v-model="apiData.shortDescription" />
                <div class="fv-plugins-message-container">
                  <div class="fv-help-block">
              ...
              <div class="d-flex flex-column mb-10 fv-row">
                ...
                <!--begin::Select-->
                <Field name="category" data-control="select2" data-hide-search="true"
                  data-placeholder="Select a Category..." class="form-select form-select-solid" as="select"
              ...
              <div class="mb-10">
                ...
                <div class="fv-row">
                  <!--begin::Select-->
                  <Field name="apiMethod" data-control="select2" data-hide-search="true"
                    data-placeholder="Select a Category..." class="form-select form-select-solid" as="select"
