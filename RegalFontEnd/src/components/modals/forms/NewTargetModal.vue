          ...
          <el-form id="kt_modal_new_target_form" @submit.prevent="submit()" :model="targetData" :rules="rules"
            ...
            <div class="d-flex flex-column mb-8 fv-row">
              ...
              <el-form-item prop="targetTitle">
                <el-input v-model="targetData.targetTitle" placeholder="Enter Target Title"
                  name="targetTitle"></el-input>
              </el-form-item>
            </div>
            <!--end::Input group-->
              ...
              <div class="col-md-6 fv-row">
                ...
                <div class="position-relative align-items-center">
                  ...
                  <el-form-item prop="dueDate">
                    <el-date-picker v-model="targetData.dueDate" type="date" placeholder="Select a date"
                      :teleported="false" popper-class="override-styles" name="dueDate" />
                  </el-form-item>
                  <!--end::Datepicker-->
                </div>
                <!--end::Input-->
            ...
            <div class="d-flex flex-column mb-8 fv-row">
              ...
              <el-form-item prop="tags">
                <el-select v-model="targetData.tags" multiple filterable allow-create default-first-option
